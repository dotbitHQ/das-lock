...
use core::str;
use std::{error::Error, process::Command, fs::File, io::{Read, BufWriter, Write}, fmt::format};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let contracts_path = "src/contracts/mod.rs";
    ...
    for f in files {
        ...
        let output_path = format!("src/contracts/{}", f);
